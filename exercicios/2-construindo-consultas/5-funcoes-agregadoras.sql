...
SELECT BillingCountry AS 'País', SUM(Total) AS 'Valor_total_vendido', MIN(Total) AS 'Valor mínimo', MAX(Total) AS 'Valor máxima', COUNT(Total) AS 'Quantidade_compras', ROUND(AVG(Total)) AS 'Ticket Médio'
FROM invoices
